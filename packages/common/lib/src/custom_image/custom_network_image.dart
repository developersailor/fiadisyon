...
import 'package:common/src/custom_image/custom_memory_cache.dart';
...
final class CustomNetworkImage extends StatelessWidget {
  ...
  const CustomNetworkImage({
    ...
    this.imageUrl,
    this.emptyWidget,
    this.memCache = const CustomMemoryCache(height: 200, width: 200),
  ...
  final CustomMemoryCache memCache;
